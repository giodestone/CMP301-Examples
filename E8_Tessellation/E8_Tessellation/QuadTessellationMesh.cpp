...
QuadTessellationMesh::QuadTessellationMesh(ID3D11Device* device, ID3D11DeviceContext* deviceContext)
{
	initBuffers(device);
}

// Release resources.
QuadTessellationMesh::~QuadTessellationMesh()
{
...
void QuadTessellationMesh::initBuffers(ID3D11Device* device)
{
	VertexType* vertices;
...
void QuadTessellationMesh::sendData(ID3D11DeviceContext* deviceContext)
{
	unsigned int stride;
	unsigned int offset;
