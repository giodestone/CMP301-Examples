...
TessellationQuadMesh::TessellationQuadMesh(ID3D11Device* device, ID3D11DeviceContext* deviceContext)
{
	initBuffers(device);
}

// Release resources.
TessellationQuadMesh::~TessellationQuadMesh()
{
...
void TessellationQuadMesh::initBuffers(ID3D11Device* device)
{
	VertexType* vertices;
...
void TessellationQuadMesh::sendData(ID3D11DeviceContext* deviceContext)
{
	unsigned int stride;
	unsigned int offset;
